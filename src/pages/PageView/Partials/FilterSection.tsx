  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between items-center gap-4 mb-2">
        <div
          className={`text-sm md:text-base font-semibold ${themeClasses.text} whitespace-nowrap`}
        >
          Bộ lọc
        </div>
        <div className="flex items-center gap-3 md:gap-4 shrink-0">
          <div
            className={`text-xs md:text-sm ${themeClasses.textSecondary} whitespace-nowrap`}
          >
            Hiển thị:{" "}
            <span
              className={`font-bold ${
      ...
      <div className="flex flex-row gap-4 md:gap-6 items-end flex-wrap">
        ...
        <div className="shrink-0 flex-1 min-w-[180px] md:min-w-[220px]">
          <div className={`${themeClasses.text} text-xs font-medium mb-1`}>
          ...
          <div className="flex gap-2 md:gap-3">
            <div className="flex-1">
              <label
                className={`text-xs ${themeClasses.textSecondary} block mb-0.5`}
              >
                Min
              </label>
              <input
                ...
                className={`w-full ${
                  theme === "light" ? "accent-indigo-600" : "accent-indigo-400"
                }`}
              />
